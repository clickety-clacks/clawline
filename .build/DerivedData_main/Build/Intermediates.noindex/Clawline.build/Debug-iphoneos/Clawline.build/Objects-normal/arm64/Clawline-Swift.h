...
#ifndef CLAWLINE_SWIFT_H
#define CLAWLINE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Clawline",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSCoder;
SWIFT_CLASS("_TtC8Clawline16AvatarCircleView")
...
SWIFT_CLASS("_TtC8Clawline18CodeBlockUIKitView")
...
SWIFT_CLASS("_TtC8Clawline21FocusableTerminalView")
...
SWIFT_CLASS("_TtC8Clawline30InteractiveHTMLBubbleUIKitView")
...
@interface InteractiveHTMLBubbleUIKitView (SWIFT_EXTENSION(Clawline)) <WKScriptMessageHandler>
...
@class NSString;
@class WKFrameInfo;
@interface InteractiveHTMLBubbleUIKitView (SWIFT_EXTENSION(Clawline)) <WKNavigationDelegate, WKUIDelegate>
...
SWIFT_CLASS("_TtC8Clawline17LinkCardUIKitView")
...
SWIFT_CLASS("_TtC8Clawline15LinkPreviewView")
...
@interface LinkPreviewView (SWIFT_EXTENSION(Clawline)) <WKScriptMessageHandler>
- (void)userContentController:(WKUserContentController * _Nonnull)userContentController didReceiveScriptMessage:(WKScriptMessage * _Nonnull)message;
@end

SWIFT_CLASS("_TtC8Clawline22MessageBubbleUIKitCell")
...
SWIFT_CLASS("_TtC8Clawline31MessageBubbleUIKitContainerView")
...
@class UITextItem;
@class UIAction;
SWIFT_CLASS("_TtC8Clawline22MessageBubbleUIKitView")
...
SWIFT_CLASS("_TtC8Clawline23MessageFailureBadgeView")
...
@class NSBundle;
SWIFT_CLASS("_TtC8Clawline35MessageFlowCollectionViewController")
...
///   </li>
/// </ol>
SWIFT_CLASS("_TtC8Clawline16PastableTextView")
...
@class NSData;
SWIFT_CLASS("_TtC8Clawline21PendingTextAttachment")
...
SWIFT_CLASS("_TtC8Clawline21TableUIKitWrapperView")
...
///   </li>
/// </ul>
SWIFT_CLASS("_TtC8Clawline23TerminalBubbleUIKitView")
...
SWIFT_CLASS("_TtC8Clawline18TruncationFadeView")
...
SWIFT_CLASS("_TtC8Clawline19TypingIndicatorCell")
