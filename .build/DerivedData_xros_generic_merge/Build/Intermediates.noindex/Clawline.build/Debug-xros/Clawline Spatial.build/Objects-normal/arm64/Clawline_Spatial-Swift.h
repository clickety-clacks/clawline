...
#ifndef CLAWLINE_SPATIAL_SWIFT_H
#define CLAWLINE_SPATIAL_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Clawline_Spatial",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSCoder;
SWIFT_CLASS("_TtC16Clawline_Spatial16AvatarCircleView")
@interface AvatarCircleView : UIView
...
SWIFT_CLASS("_TtC16Clawline_Spatial18CodeBlockUIKitView")
@interface CodeBlockUIKitView : UIView
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC16Clawline_Spatial21FocusableTerminalView")
@interface FocusableTerminalView : TerminalView
- (void)touchesBegan:(NSSet<UITouch *> * _Nonnull)touches withEvent:(UIEvent * _Nullable)event;
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end

SWIFT_CLASS("_TtC16Clawline_Spatial30InteractiveHTMLBubbleUIKitView")
@interface InteractiveHTMLBubbleUIKitView : UIView
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
...
@interface InteractiveHTMLBubbleUIKitView (SWIFT_EXTENSION(Clawline_Spatial)) <WKScriptMessageHandler>
...
@class NSString;
@class WKFrameInfo;
@interface InteractiveHTMLBubbleUIKitView (SWIFT_EXTENSION(Clawline_Spatial)) <WKNavigationDelegate, WKUIDelegate>
...
SWIFT_CLASS("_TtC16Clawline_Spatial17LinkCardUIKitView")
@interface LinkCardUIKitView : UIControl
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC16Clawline_Spatial15LinkPreviewView")
@interface LinkPreviewView : UIView <UIGestureRecognizerDelegate, WKNavigationDelegate, WKUIDelegate>
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
- (void)didMoveToWindow;
@property (nonatomic, readonly) CGSize intrinsicContentSize;
...
@interface LinkPreviewView (SWIFT_EXTENSION(Clawline_Spatial)) <WKScriptMessageHandler>
- (void)userContentController:(WKUserContentController * _Nonnull)userContentController didReceiveScriptMessage:(WKScriptMessage * _Nonnull)message;
@end

SWIFT_CLASS("_TtC16Clawline_Spatial22MessageBubbleUIKitCell")
@interface MessageBubbleUIKitCell : UICollectionViewCell
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC16Clawline_Spatial31MessageBubbleUIKitContainerView")
@interface MessageBubbleUIKitContainerView : UIView
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
...
@class UITextItem;
@class UIAction;
SWIFT_CLASS("_TtC16Clawline_Spatial22MessageBubbleUIKitView")
@interface MessageBubbleUIKitView : UIView <UITextViewDelegate>
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
- (void)layoutSubviews;
...
SWIFT_CLASS("_TtC16Clawline_Spatial23MessageFailureBadgeView")
@interface MessageFailureBadgeView : UIView
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
...
@class NSBundle;
SWIFT_CLASS("_TtC16Clawline_Spatial35MessageFlowCollectionViewController")
@interface MessageFlowCollectionViewController : UIViewController <UICollectionViewDelegateFlowLayout>
...
/// <ol>
///   <li>
///     <code>paste(_:)</code> – UIResponder action from the edit menu
///   </li>
///   <li>
///     <code>paste(itemProviders:)</code> – UITextPasteConfigurationSupporting
///   </li>
///   <li>
///     <code>UITextPasteDelegate.transforming</code> – item-level safety net that discards
///     image items before they can be converted to text
///   </li>
/// </ol>
SWIFT_CLASS("_TtC16Clawline_Spatial16PastableTextView")
@interface PastableTextView : UITextView <UITextPasteDelegate>
...
@class NSData;
SWIFT_CLASS("_TtC16Clawline_Spatial21PendingTextAttachment")
@interface PendingTextAttachment : NSTextAttachment
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC16Clawline_Spatial21TableUIKitWrapperView")
@interface TableUIKitWrapperView : UIView
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
...
///   </li>
/// </ul>
SWIFT_CLASS("_TtC16Clawline_Spatial23TerminalBubbleUIKitView")
@interface TerminalBubbleUIKitView : UIView
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
- (void)didMoveToWindow;
@end

SWIFT_CLASS("_TtC16Clawline_Spatial18TruncationFadeView")
@interface TruncationFadeView : UIView
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
- (void)layoutSubviews;
@end

SWIFT_CLASS("_TtC16Clawline_Spatial19TypingIndicatorCell")
@interface TypingIndicatorCell : UICollectionViewCell
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
- (void)prepareForReuse;
@end
