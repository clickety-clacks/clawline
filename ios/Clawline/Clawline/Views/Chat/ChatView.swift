...
struct ChatView: View {
    ...
    private func messageList(topInset: CGFloat,
        ...
        let list = MessageFlowCollectionView(
            ...
            sessionControlUnavailableReason: viewModel.isSessionStatusUnavailable(for: sessionKey)
                ? "session_status_unavailable"
                : (viewModel.isSessionStatusStale(for: sessionKey) ? "session_status_stale" : nil),
